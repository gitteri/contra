/**
 * Production server for the Contra User Simulator UI.
 *
 ...
 *   CONTRA_READ_URL  - Contra read RPC endpoint  (default: https://read-node-production.up.railway.app)
 *   CONTRA_WRITE_URL - Contra write RPC endpoint  (default: https://write-node-production.up.railway.app)
...
server.listen(PORT, () => {
  console.log(`User UI server listening on :${PORT}`);
